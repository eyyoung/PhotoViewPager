...
public class RevealCircleImageView extends ImageView {
    ...
    private static class RevealProperty extends Property<RevealCircleImageView, Float> {
        ...
        @Override
        public Float get(RevealCircleImageView revealCircleImageView) {
            return revealCircleImageView.mDrawableRadius;
        }

        @Override
        public void set(RevealCircleImageView object, Float value) {
    ...
    public RevealCircleImageView(Context context) {
        super(context);

        init();
    }

    public RevealCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RevealCircleImageView(Context context, AttributeSet attrs, int defStyle) {
